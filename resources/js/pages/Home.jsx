            ...
            <section className="t10-hero" id="beranda">
                <div
                    ...
                    style={{
                        ...
                        right: -100,
                        background:
                            'radial-gradient(circle, rgba(232,84,60,0.28), transparent 70%)',
                    }}
                />
                <div
                    className="t10-blob"
                    style={{
                        ...
                        left: -80,
                        background:
                            'radial-gradient(circle, rgba(61,53,87,0.16), transparent 70%)',
                    }}
                />
                ...
                <div className="t10-wrap">
                    ...
                    <p className="t10-hero-sub">
                        Enam orang, satu kerangka kerja, dan satu semester untuk
                        membangun sesuatu yang layak dipakai — bukan sekadar
                        dikumpulkan.
                    </p>
                ...
                <div className="t10-wrap">
                    <div className="t10-section-head">
                        ...
                        <p className="t10-section-desc">
                            Tim ini dibentuk untuk mata kuliah PBKK. Tiga hal
                            ini yang memandu bagaimana kami membagi tugas dan
                            mengambil keputusan sepanjang proyek berjalan.
                        </p>
                    </div>
