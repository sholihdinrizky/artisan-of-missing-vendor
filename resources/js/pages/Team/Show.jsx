            ...
            <section className="t10-section" style={{ paddingTop: 64 }}>
                <div className="t10-wrap">
                    ...
                    <div className="t10-detail-head">
                        <div className={`t10-avatar lg ${avatarClass}`}>
                    ...
                    <div className="t10-contact-row">
                        ...
                        {member.contact?.github && (
                            ...
                            >
                                <img
                                    className="h-6 w-6"
                                    src="https://raw.githubusercontent.com/gilbarbara/logos/a5b65275e761a8347a99eded1101c6b130a06e52/logos/github-icon.svg"
                                    alt=""
                                />
                            </a>
                        )}
