            ...
            <section className="t10-hero">
                <div
                    ...
                    style={{
                        ...
                        right: -60,
                        background:
                            'radial-gradient(circle, rgba(240,180,41,0.30), transparent 70%)',
                    }}
                />
                ...
                <div className="t10-wrap">
                    <div className="t10-about-banner">
                        <span className="t10-tag">
                            <Sparkles size={14} /> Kelompok 10 DTIF ITS • FTEIC
                            ITS • Agentic AI Sub-Theme
                        </span>
                        ...
                        >
                            ...
                            <span className="accented">ITS</span>
                        </h1>
                    ...
                    <div className="t10-section-head">
                        <div>
                            ...
                            <h2 className="t10-section-title">
                                Arah & Komitmen Departemen.
                            </h2>
                        </div>
                        <p className="t10-section-desc">
                            Menjadi pionir pendidikan dan riset informatika yang
                            berorientasi pada masa depan kecerdasan buatan dan
                            industri global.
                        </p>
                    </div>
                    ...
                    <div className="t10-visi-misi-grid">
                        ...
                        <div className="t10-card-box t10-visi-box">
                            ...
                            <p className="t10-box-text">
                                ...
                                lingkungan, maka visi Departemen Informatika
                                adalah menjadi inovator bidang informatika yang
                                unggul di tingkat nasional dengan reputasi
                                internasional, serta berperan aktif dalam upaya
                            ...
                            <p className="t10-box-text">
                                Visi Departemen Teknik Informatika (DTIF)
                                berfokus untuk menjadi lembaga pendidikan yang
                                unggul dan inovatif-inventif dalam informatika
                                cerdas, mendukung transformasi digital dan
                                berkontribusi kepada masyarakat dengan reputasi
                                internasional.
                            </p>
                        </div>
            ...
            >
                <div className="t10-wrap">
                    <div className="t10-section-head">
                        <div>
                            <span className="t10-tag">
                                <GraduationCap size={14} /> 6 Jenjang Program
                                Studi
                            </span>
                            <h2 className="t10-section-title">
                                Program Studi DTIF FTEIC ITS.
                            </h2>
                        </div>
                        <p className="t10-section-desc">
                            Departemen Teknik Informatika FTEIC ITS
                            menyelenggarakan 6 jenjang program studi dari
                        ...
                        {PRODI_LIST.map((p, i) => (
                            ...
                            >
                                <div className="t10-prodi-top">
                                    <span className="t10-prodi-badge">
                                        {p.badge}
                                    </span>
                                    <span className="t10-prodi-sub">
                                        {p.subtitle}
                                    </span>
                                </div>
                                <h3>{p.title}</h3>
                ...
                <div className="t10-wrap">
                    <div className="t10-section-head">
                        <div>
                            ...
                            <h2 className="t10-section-title">
                                Laboratorium Bidang Minat.
                            </h2>
                        </div>
                        <p className="t10-section-desc">
                            Terdapat 6 laboratorium utama pendukung riset,
                            inovasi, dan kegiatan pembelajaran di DTIF ITS:
                        </p>
                    </div>
                ...
                <div className="t10-team-cta-box">
                    <div>
                        ...
                        <p style={{ color: 'var(--muted)', margin: 0 }}>
                            Lihat profil 6 mahasiswa pengembang proyek Team 10
                            PBKK.
                        </p>
                    </div>
